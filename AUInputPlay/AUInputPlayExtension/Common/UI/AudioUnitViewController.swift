...
private let log = Logger(subsystem: "com.iamhabi.AUInputPlayExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<AUInputPlayExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try AUInputPlayExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? AUInputPlayExtensionAudioUnit else {
            log.error("Unable to create AUInputPlayExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(AUInputPlayExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = AUInputPlayExtensionMainView(parameterTree: observableParameterTree)
